export { PageContactAnimated } from "./data/contact/page.animate";

export { PageCompetencyAnimated } from "./data/competency/page.animate";

export { PageAboutAnimated } from "./data/about/page.animate";

export { PageMainAnimated } from "./data/main/page.animate";

export { PageTeamAnimated } from "./data/team/page.animate";
